...
practicing outside-in BDD/TDD, domain-driven design (DDD), and with using
some newer, cutting edge tools.
...
* Notes/Comments/Reviews => managing history of trips (like a journal)
...
- deploy to heroku
- run an Ubuntu VM as execution stack: vagrant or Docker
